...
public class lostfound implements Serializable {
    private int id_lostfound;//条目的id
    ...
    public lostfound(int ownerId, String describe, int pic, int integral, String time, int flag, int common_count, String nickname, String title) {
